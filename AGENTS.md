...
- Define shared terms early and write stable terms into the repo context file before using them repeatedly.
- When saying "task", "module", "adapter", "wrapper", "runtime", or "bridge", define the concrete file or class being discussed.
- Separate "who defines semantics" from "who executes mechanics". For example, a task may define action meaning while a physics backend executes prepared control tensors.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/rpg_flightning/context` | Codebase overview, check index freshness |
| `gitnexus://repo/rpg_flightning/clusters` | All functional areas |
| `gitnexus://repo/rpg_flightning/processes` | All execution flows |
| `gitnexus://repo/rpg_flightning/process/{name}` | Step-by-step execution trace |
